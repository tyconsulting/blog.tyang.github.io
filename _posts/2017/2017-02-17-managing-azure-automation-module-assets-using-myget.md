...
<span style="background-color: #ffff00;">https://www.myget.org/F/<feed-name>/**auth/&lt;api-key&gt;/**api/v2</span>
...
My MVP buddy Alex Verkinderen also also done some interesting integration between MyGet and PowerShell Gallery. He is going to publish his innovation on his blog (<a title="http://www.mscloud.be/" href="http://www.mscloud.be/">http://www.mscloud.be/</a>) soon, so make sure you subscribe to his blog :smiley:.
