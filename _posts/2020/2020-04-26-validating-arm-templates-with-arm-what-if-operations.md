...
* Resource group level: <a href="https://docs.microsoft.com/en-us/powershell/module/az.resources/test-azresourcegroupdeployment" target="_blank" rel="noopener noreferrer">Test-AzResourceGroupDeployment</a>
* Subscription level: <a href="https://docs.microsoft.com/en-us/powershell/module/az.resources/test-azdeployment" target="_blank" rel="noopener noreferrer">Test-AzDeployment</a>
* Management Group level: <a href="https://docs.microsoft.com/en-us/powershell/module/az.resources/test-azmanagementgroupdeployment" target="_blank" rel="noopener noreferrer">Test-AzManagementGroupDeployment</a>
* Tenant level: <a href="https://docs.microsoft.com/en-us/powershell/module/az.resources/test-aztenantdeployment" target="_blank" rel="noopener noreferrer">Test-AzTenantDeployment</a>
