...
I am going to demonstrate how to create these event collection rules using a SMA runbook which uses The **<a href="http://www.tyconsulting.com.au/portfolio/opsmgrextended-powershell-and-sma-module/" target="_blank">OpsMgrExtended PowerShell module</a>**. In order to implement this solution, you will need the following:
...
* <a href="http://www.microsoft.com/en-us/download/details.aspx?id=34709" target="_blank">Microsoft ConfigMgr 2012 management pack version 5.0.7804.1000</a> imported and configured in your OpsMgr management group
