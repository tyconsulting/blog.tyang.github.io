...
* Management Group ID: <same as your tenant Id>
...
* Script Arguments: –inputFile <path to the input file for the stage> <font style="background-color: rgb(255, 255, 0);">–silent –whatif</font>
...
**NOTE:** When this step runs, the scripts will skip any existing management groups that are defined in the input file, and skip any subscriptions that are already placed in the correct management group. The script will <strong>DO NOTHING</strong> to any existing management groups that are not defined in the input file.
