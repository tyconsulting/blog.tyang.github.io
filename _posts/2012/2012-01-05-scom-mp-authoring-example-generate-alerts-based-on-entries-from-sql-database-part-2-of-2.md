...
author: Tao Yang
#layout: post
guid: https://blog.tyang.org/?p=833
...
tags:
  ...
  - SCOM
---
This is the 2nd part of the 2-part series.  Part 1 can be found <a title="SCOM MP Authoring Example: Generate alerts based on entries from SQL Database (Part 1 of 2)" href="https://blog.tyang.org/2012/01/04/scom-mp-authoring-example-generate-alerts-based-on-entries-from-sql-database-part-1-of-2/">here</a>.
...
![1](https://blog.tyang.org/wp-content/uploads/2012/01/image1.png)

{:start="4"}
4. Under Member Modules, add **Microsoft.Windows.PowerShellPropertyBagTriggerOnlyProbe** and give it a Module ID of "PSScript"

![2](https://blog.tyang.org/wp-content/uploads/2012/01/image2.png)
...
![3](https://blog.tyang.org/wp-content/uploads/2012/01/image3.png)
...
![4](https://blog.tyang.org/wp-content/uploads/2012/01/image4.png)
...
![8](https://blog.tyang.org/wp-content/uploads/2012/01/image8.png)
...
![9](https://blog.tyang.org/wp-content/uploads/2012/01/image9.png)
...
![10](https://blog.tyang.org/wp-content/uploads/2012/01/image10.png)
...
![11](https://blog.tyang.org/wp-content/uploads/2012/01/image11.png)

{:start="6"}
6. Edit the probe action module, use promote to set values for all 3 parameters:

![12](https://blog.tyang.org/wp-content/uploads/2012/01/image12.png)

{:start="7"}
7. Configure "Configuration Schema" tab as below (again, make sure these parameters are in the right order"):

![13](https://blog.tyang.org/wp-content/uploads/2012/01/image13.png)

{:start="8"}
8. Configure Overridable Parameters as below:

![14](https://blog.tyang.org/wp-content/uploads/2012/01/image14.png)

{:start="9"}
9. Make sure output data type is set to **System.PropertyBagData**

![15](https://blog.tyang.org/wp-content/uploads/2012/01/image15.png)
...
![16](https://blog.tyang.org/wp-content/uploads/2012/01/image16.png)
...
![17](https://blog.tyang.org/wp-content/uploads/2012/01/image17.png)
...
![18](https://blog.tyang.org/wp-content/uploads/2012/01/image18.png)
...
![19](https://blog.tyang.org/wp-content/uploads/2012/01/image19.png)
...
![20](https://blog.tyang.org/wp-content/uploads/2012/01/image20.png)

{:start="9"}
9. Create an Action module. Type: **System.Health.GenerateAlert**. ModuleID: **Alert**.

![21](https://blog.tyang.org/wp-content/uploads/2012/01/image21.png)
...
```
![22](https://blog.tyang.org/wp-content/uploads/2012/01/image22.png)
...
![23](https://blog.tyang.org/wp-content/uploads/2012/01/image23.png)
...
![24](https://blog.tyang.org/wp-content/uploads/2012/01/image24.png)


My sample PowerShell script can be downloaded from [HERE](https://blog.tyang.org/wp-content/uploads/2012/01/AuditDBAlarmCatcher.txt)